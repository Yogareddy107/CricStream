...
const teams = [
    { name: "Royal Challengers Bengaluru", matches: 2, wins: 2, losses: 0, points: 4, nrr: "+2.266", color: "#DA1818", logo: "🔴" },
    ...
    { name: "Chennai Super Kings", matches: 2, wins: 1, losses: 1, points: 2, nrr: "-1.013", color: "#F7D720", logo: "🦁" },
            ...
            <table className="table table-bordered">
                ...
                <tbody>
                    {teams.map((team, index) => (
                        <tr key={index} style={{ backgroundColor: team.color, color: "#FFFFFF" }}>
